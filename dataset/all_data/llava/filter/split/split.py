...
def main():
    ...
    out_train_obvious = "dataset/all_data/llava/filter/split/train_obvious.jsonl"
    out_train_elusive = "dataset/all_data/llava/filter/split/train_elusive.jsonl"
    out_train_nh = "dataset/all_data/llava/filter/split/train_nh_full.jsonl"

    out_val_obvious = "dataset/all_data/llava/filter/split/val_obvious.jsonl"
    out_val_elusive = "dataset/all_data/llava/filter/split/val_elusive.jsonl"
    out_val_nh = "dataset/all_data/llava/filter/split/val_nh_full.jsonl"

    out_test_obvious = "dataset/all_data/llava/filter/split/test_obvious.jsonl"
    out_test_elusive = "dataset/all_data/llava/filter/split/test_elusive.jsonl"
    out_test_nh = "dataset/all_data/llava/filter/split/test_nh_full.jsonl"

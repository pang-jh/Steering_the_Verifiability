...
def main():
    obvious_path = "/dataset/all_data/llava/filter/obvious_filter.jsonl"
    elusive_path = "/dataset/all_data/llava/filter/elusive_filter.jsonl"
    nh_path = "/dataset/all_data/llava/filter/nh_filter.jsonl"

    out_train_obvious = "/dataset/all_data/llava/filter/pure_balance/train_obvious.jsonl"
    out_train_elusive = "/dataset/all_data/llava/filter/pure_balance/train_elusive.jsonl"
    out_train_nh = "/dataset/all_data/llava/filter/pure_balance/train_nh_full.jsonl"

    out_val_obvious = "/dataset/all_data/llava/filter/pure_balance/val_obvious.jsonl"
    out_val_elusive = "/dataset/all_data/llava/filter/pure_balance/val_elusive.jsonl"
    out_val_nh = "/dataset/all_data/llava/filter/pure_balance/val_nh_full.jsonl"

    out_test_obvious = "/dataset/all_data/llava/filter/pure_balance/test_obvious.jsonl"
    out_test_elusive = "/dataset/all_data/llava/filter/pure_balance/test_elusive.jsonl"
    out_test_nh = "/dataset/all_data/llava/filter/pure_balance/test_nh_full.jsonl"
    ...
    print(f"Train nh balance((gt=否,pred=否或不确定):(gt=是,pred=是)) = {tr_neg}:{tr_yes_yes}")
    print(f"Val nh balance((gt=否,pred=否或不确定):(gt=是,pred=是)) = {v_neg}:{v_yes_yes}")
    print(f"Test nh balance((gt=否,pred=否或不确定):(gt=是,pred=是)) = {t_neg}:{t_yes_yes}")
